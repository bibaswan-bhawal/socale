...
class AuthRoutePath extends AppRoutePath {
  ...
  AuthRoutePath.signUp()
      : appState = AuthState(step: AuthStep.register, previousStep: AuthStep.getStarted);
  AuthRoutePath.signIn()
      : appState = AuthState(step: AuthStep.login, previousStep: AuthStep.getStarted);
  AuthRoutePath.verifyEmail(AuthStep previousStep)
      : appState = AuthState(step: AuthStep.verifyEmail, previousStep: previousStep);
  AuthRoutePath.forgotPassword()
      : appState = AuthState(step: AuthStep.forgotPassword, previousStep: AuthStep.login);
}
