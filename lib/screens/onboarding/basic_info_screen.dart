...
class BasicInfoScreen extends OnboardingScreen {
  const BasicInfoScreen({super.key});

  @override
  OnboardingScreenState createState() => _BasicInfoScreenState();
}

class _BasicInfoScreenState extends OnboardingScreenState {
