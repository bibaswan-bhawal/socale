...
class QuestionThreePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<QuestionThreePage> createState() => _QuestionThreePageState();
}
...
class _QuestionThreePageState extends ConsumerState<QuestionThreePage> {
  ...
  onChanged(double value) {
    ...
    dataNotifier.setQuestionValue(value.round(), 2);
  }
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                      left: constraints.onboardingSituational3ImagePadding,
                      right: constraints.onboardingSituational3ImagePadding,
                    ),
                    child: Image.asset('assets/images/onboarding_illustration_9.png'),
                  ),
                  Center(
                    child: Padding(
                      ...
                      children: [
                        Material(
                          ...
                          child: Slider(
                            ...
                            value: dataProvider.getQuestions[2].toDouble(),
                            max: 100,
                            onChanged: onChanged,
                          ),
                        ),
