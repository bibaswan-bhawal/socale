...
class QuestionFourPage extends ConsumerStatefulWidget {
  const QuestionFourPage({Key? key}) : super(key: key);

  @override
  ConsumerState<QuestionFourPage> createState() => _QuestionFourPageState();
}

class _QuestionFourPageState extends ConsumerState<QuestionFourPage> {
  ...
  onChanged(double value) {
    ...
    dataNotifier.setQuestionValue(value.round(), 3);
  }
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                      left: constraints.onboardingSituational4ImagePadding,
                      right: constraints.onboardingSituational4ImagePadding,
                    ),
                    child: Image.asset('assets/images/onboarding_illustration_10.png'),
                  ),
                  Center(
                    child: Padding(
                      ...
                      children: [
                        Material(
                          ...
                          child: Slider(
                            ...
                            value: dataProvider.getQuestions[3].toDouble(),
                            max: 100,
                            onChanged: onChanged,
                          ),
                        ),
