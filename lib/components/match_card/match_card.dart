      ...
      Navigator.of(context).push(
        PageRouteBuilder(
          pageBuilder: (context, animation, secondaryAnimation) =>
              ChatPage(room: MatchRoom(user: widget.user)),
  ...
  Widget build(BuildContext context) {
    ...
    for (String interest in academicInterests) {
      if (academicInterestsOptionsList.containsKey(interest)) {
        ...
        String key = academicInterestsOptionsList.keys
            .where(
                (key) => academicInterestsOptionsList[key]!.contains(interest))
            .first;
    ...
    for (String hobby in hobbies) {
      if (hobbiesOptionsList.containsKey(hobby)) {
        ...
        String key = hobbiesOptionsList.keys
            .where((key) => hobbiesOptionsList[key]!.contains(hobby))
            .first;
      ...
      child: Stack(
        children: [
          GradientBorderCard(
            ...
            gradientColor:
                matchPercentageConverter.convertPercentageToColorList(
                  ...
                  child: Column(
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding:
                              EdgeInsets.only(left: 40, top: 5, bottom: 10),
                          child: Text(
                            "Also interested In",
                            style: GoogleFonts.poppins(
                              color: Colors.white,
