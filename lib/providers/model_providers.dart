...
final currentUserProvider =
    StateNotifierProvider.autoDispose<CurrentUserNotifier, CurrentUser>((ref) => CurrentUserNotifier(ref));
final onboardingUserProvider =
    StateNotifierProvider.autoDispose<OnboardingUserNotifier, OnboardingUser>((ref) => OnboardingUserNotifier(ref));
