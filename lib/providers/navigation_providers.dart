...
import 'package:socale/navigation/onboarding/onboarding_router_delegate.dart';
import 'package:socale/providers/state_providers.dart';

final mainRouterDelegateProvider = Provider.autoDispose((ref) => MainRouterDelegate(ref));
final onboardingRouterDelegateProvider = Provider.autoDispose((ref) => OnboardingRouterDelegate());
