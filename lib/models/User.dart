...
class User extends Model {
  ...
  const User._internal(
      ...
      required academicInclination,
      required firstName,
      lastName,
      required dateOfBirth,
      required graduationMonth,
      required major,
      required minor,
      required academicInterests,
      required skills,
      required careerGoals,
      required selfDescription,
      required leisureInterests,
      required idealFriendDescription,
      required situationalDecisions,
      required college,
      required matches,
      required publicKey,
      required privateKey,
      ...
      : _email = email,
        ...
        _academicInclination = academicInclination,
        _firstName = firstName,
        _lastName = lastName,
        _dateOfBirth = dateOfBirth,
        _graduationMonth = graduationMonth,
        _major = major,
        _minor = minor,
        _academicInterests = academicInterests,
        _skills = skills,
        _careerGoals = careerGoals,
        _selfDescription = selfDescription,
        _leisureInterests = leisureInterests,
        _idealFriendDescription = idealFriendDescription,
        _situationalDecisions = situationalDecisions,
        _college = college,
        _matches = matches,
  ...
  factory User(
      ...
      required int academicInclination,
      required String firstName,
      String? lastName,
      required TemporalDate dateOfBirth,
      required TemporalDate graduationMonth,
      required List<String> major,
      required List<String> minor,
      required List<String> academicInterests,
      required List<String> skills,
      required List<String> careerGoals,
      required List<String> selfDescription,
      required List<String> leisureInterests,
      required String idealFriendDescription,
    ...
    return User._internal(
        ...
        academicInterests: academicInterests != null
            ? List<String>.unmodifiable(academicInterests)
            : academicInterests,
        skills: skills != null ? List<String>.unmodifiable(skills) : skills,
        careerGoals: careerGoals != null
            ? List<String>.unmodifiable(careerGoals)
            : careerGoals,
        selfDescription: selfDescription != null
            ? List<String>.unmodifiable(selfDescription)
            : selfDescription,
        leisureInterests: leisureInterests != null
            ? List<String>.unmodifiable(leisureInterests)
            : leisureInterests,
        idealFriendDescription: idealFriendDescription,
        situationalDecisions: situationalDecisions != null
            ? List<int>.unmodifiable(situationalDecisions)
            : situationalDecisions,
        college: college,
        matches: matches != null ? List<String>.unmodifiable(matches) : matches,
        publicKey: publicKey,
        privateKey: privateKey != null
            ? List<int>.unmodifiable(privateKey)
            : privateKey,
        messages:
            messages != null ? List<Message>.unmodifiable(messages) : messages,
        userRoom: userRoom != null
            ? List<UserRoom>.unmodifiable(userRoom)
            : userRoom);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is User &&
        ...
        DeepCollectionEquality()
            .equals(_academicInterests, other._academicInterests) &&
        DeepCollectionEquality().equals(_skills, other._skills) &&
        DeepCollectionEquality().equals(_careerGoals, other._careerGoals) &&
        DeepCollectionEquality()
            .equals(_selfDescription, other._selfDescription) &&
        DeepCollectionEquality()
            .equals(_leisureInterests, other._leisureInterests) &&
        _idealFriendDescription == other._idealFriendDescription &&
        DeepCollectionEquality()
            .equals(_situationalDecisions, other._situationalDecisions) &&
  ...
  String toString() {
    ...
    buffer.write("academicInclination=" +
        (_academicInclination != null
            ? _academicInclination!.toString()
            : "null") +
        ", ");
    ...
    buffer.write("dateOfBirth=" +
        ...
        ", ");
    buffer.write("graduationMonth=" +
        (_graduationMonth != null ? _graduationMonth!.format() : "null") +
        ", ");
    buffer.write(
        "major=" + (_major != null ? _major!.toString() : "null") + ", ");
    buffer.write(
        "minor=" + (_minor != null ? _minor!.toString() : "null") + ", ");
    buffer.write("academicInterests=" +
        (_academicInterests != null ? _academicInterests!.toString() : "null") +
        ", ");
    buffer.write(
        "skills=" + (_skills != null ? _skills!.toString() : "null") + ", ");
    buffer.write("careerGoals=" +
        (_careerGoals != null ? _careerGoals!.toString() : "null") +
        ", ");
    buffer.write("selfDescription=" +
        (_selfDescription != null ? _selfDescription!.toString() : "null") +
        ", ");
    buffer.write("leisureInterests=" +
        (_leisureInterests != null ? _leisureInterests!.toString() : "null") +
        ", ");
    buffer.write("idealFriendDescription=" + "$_idealFriendDescription" + ", ");
    buffer.write("situationalDecisions=" +
        (_situationalDecisions != null
            ? _situationalDecisions!.toString()
            : "null") +
        ", ");
    buffer.write("college=" + "$_college" + ", ");
    buffer.write(
        "matches=" + (_matches != null ? _matches!.toString() : "null") + ", ");
    buffer.write("publicKey=" + "$_publicKey" + ", ");
    buffer.write("privateKey=" +
        (_privateKey != null ? _privateKey!.toString() : "null") +
        ", ");
  ...
  User copyWith(
      ...
      String? email,
      String? schoolEmail,
      int? academicInclination,
      String? firstName,
      String? lastName,
      TemporalDate? dateOfBirth,
      TemporalDate? graduationMonth,
      List<String>? major,
      List<String>? minor,
      List<String>? academicInterests,
      List<String>? skills,
      List<String>? careerGoals,
      List<String>? selfDescription,
      List<String>? leisureInterests,
      String? idealFriendDescription,
    ...
    return User._internal(
        ...
        idealFriendDescription:
            idealFriendDescription ?? this.idealFriendDescription,
  ...
  User.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _dateOfBirth = json['dateOfBirth'] != null
            ...
            : null,
        _graduationMonth = json['graduationMonth'] != null
            ? TemporalDate.fromString(json['graduationMonth'])
            : null,
        ...
        _situationalDecisions = (json['situationalDecisions'] as List?)
            ?.map((e) => (e as num).toInt())
            .toList(),
        _college = json['college'],
        _matches = json['matches']?.cast<String>(),
        _publicKey = json['publicKey'],
        _privateKey = (json['privateKey'] as List?)
            ?.map((e) => (e as num).toInt())
            .toList(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        'academicInclination': _academicInclination,
        'firstName': _firstName,
        'lastName': _lastName,
        'dateOfBirth': _dateOfBirth?.format(),
        'graduationMonth': _graduationMonth?.format(),
        'major': _major,
        'minor': _minor,
        'academicInterests': _academicInterests,
        'skills': _skills,
        'careerGoals': _careerGoals,
        'selfDescription': _selfDescription,
        'leisureInterests': _leisureInterests,
        'idealFriendDescription': _idealFriendDescription,
        'situationalDecisions': _situationalDecisions,
        'college': _college,
        'matches': _matches,
        'publicKey': _publicKey,
        'privateKey': _privateKey,
        'messages': _messages?.map((Message? e) => e?.toJson()).toList(),
        'userRoom': _userRoom?.map((UserRoom? e) => e?.toJson()).toList(),
  ...
  static final QueryField ACADEMICINCLINATION =
      QueryField(fieldName: "academicInclination");
  static final QueryField FIRSTNAME = QueryField(fieldName: "firstName");
  static final QueryField LASTNAME = QueryField(fieldName: "lastName");
  static final QueryField DATEOFBIRTH = QueryField(fieldName: "dateOfBirth");
  static final QueryField GRADUATIONMONTH =
      QueryField(fieldName: "graduationMonth");
  static final QueryField MAJOR = QueryField(fieldName: "major");
  static final QueryField MINOR = QueryField(fieldName: "minor");
  static final QueryField ACADEMICINTERESTS =
      QueryField(fieldName: "academicInterests");
  ...
  static final QueryField SELFDESCRIPTION =
      QueryField(fieldName: "selfDescription");
  static final QueryField LEISUREINTERESTS =
      QueryField(fieldName: "leisureInterests");
  static final QueryField IDEALFRIENDDESCRIPTION =
      QueryField(fieldName: "idealFriendDescription");
  static final QueryField SITUATIONALDECISIONS =
      QueryField(fieldName: "situationalDecisions");
